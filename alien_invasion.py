...
class AlienInvasion:
    ...
    def _start_game(self,reset_game):
        '''Initalize game setup.'''
        if reset_game == True and not self.stats.game_active:
            ...
            # Get rid of any remaingin aliens and bullets.
            self.aliens.empty()
            self.bullets.empty()
...
# Bullet Methods
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Create a new fleet when the aliens are all destroyed
        if not self.aliens:
